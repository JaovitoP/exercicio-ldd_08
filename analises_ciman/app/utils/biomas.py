...
def analisador_bioma(bioma, ano, ano_i, ano_f):
  url_focos_bioma = f"https://data.inpe.br/queimadas/portal/csv/download/historico-mensal/biomas/{bioma}.csv"
  df_focos = ajusta_serie_temporal( preparar_focos(url_focos_bioma) )
  df_focos = df_focos[df_focos.index.year < ano].copy() #até
